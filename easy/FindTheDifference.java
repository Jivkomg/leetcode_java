...
/**
 * Created by zhivkogeorgiev on 6/4/18.
...
public class FindTheDifference {
    public static char findTheDifference(String s, String t) {
        int sumInputCode = 0;
        int sumNewStringCode = 0;
        char[] sChars = s.toCharArray();
        char[] tChars = t.toCharArray();
        for(int i = 0; i < s.length(); i++){
            sumNewStringCode += (int)tChars[i];
            sumInputCode += (int)sChars[i];
        }
        sumNewStringCode += (int)tChars[tChars.length - 1];
        return (char)(sumNewStringCode - sumInputCode);
    }
